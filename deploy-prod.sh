...
echo "📊 Step 8: Updating subgraph configuration..."

SUBGRAPH_CONFIG="packages/v2-subgraph/config/monad-testnet/config.json"
...
EOF
    ...
    echo "⚠️  Warning: Subgraph config file not found at $SUBGRAPH_CONFIG"
fi
